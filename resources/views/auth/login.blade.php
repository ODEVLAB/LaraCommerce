...
<html lang="en">
    ...
    <link rel="stylesheet" href="{{asset ('auth/bundles/bootstrap-social/bootstrap-social.css') }}">
    <link rel="stylesheet" href="{{asset ('auth/css/style.css') }}">
    <link rel="stylesheet" href="{{asset ('auth/css/components.css') }}">
    <link rel="shortcut icon" type="image/x-icon" href="{{asset ('auth/img/favicon.ico') }}">
  </head>
                ...
                <div class="card-body">
                  <form class="needs-validation" novalidate="" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group">
                      ...
                      <input id="password" name="password" type="password" tabindex="2" class="form-control @error('password') is-invalid @enderror" required autocomplete="current-password">
                      @error('password')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
