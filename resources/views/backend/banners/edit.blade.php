                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{route('banner.update' , $banner->id) }}" class="horizontal-form">
                                    @csrf
                                    @method('patch')
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Title</label>
                                                <input type="text" class="form-control" id="title" value="{{$banner->title}}" name="title" placeholder="Title">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" class="summernote form-control"  placeholder="Write Description">{{$banner->description}}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
